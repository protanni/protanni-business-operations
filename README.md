...
This repository documents the Business Operations infrastructure being built around PROTANNI as a real 0→1 digital product. The goal is to translate product strategy into a measurable, scalable operating system and to demonstrate the applied work behind the decisions, processes, models, and controls used to run the business.

The production application and source code remain separate and private. This repository focuses on the operating model and portfolio-safe evidence.
...
- `11-project-management/` — charter, stakeholder map, risk register, decision log, retrospective
...
Any operational data used here will be synthetic, anonymized, aggregated, or intentionally public. Screenshots, workflow exports, models, and examples will be sanitized before publication.
